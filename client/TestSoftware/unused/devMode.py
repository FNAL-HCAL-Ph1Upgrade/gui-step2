# This is development version of the NGCCM GUI
...
class makeGui:
	def __init__(self, parent):
		...
		# Make and pack a text label for ######Write Placeholder############
                self.qieWriteLabel = Label(self.qie_subBot_frame, text="Write Placeholder: ")
                self.qieWriteLabel.configure(
                        padx=button_padx,
                        pady=button_pady,
                        background="white"
                        )
                self.qieWriteLabel.pack(side=LEFT)

		# Make and pack a PLACEHOLDER LISTBOX for the variable to write:
                self.qie_writeBox = OptionMenu(self.qie_subBot_frame, self.qieWriteVar,
                                              "Placeholder W1","Placeholder W2",
                                              "Placeholder W3","Placeholder W4")
                self.qie_writeBox.pack(side=LEFT)
                self.qieWriteVar.set("Placeholder W1") # initializes the OptionMenu
		...
		# Make and pack a text label for ######Read Placeholder############
                self.qieReadLabel = Label(self.qie_subMid_frame, text="Read Placeholder: ")
		...
		# Make and pack a PLACEHOLDER LISTBOX for the variable to read:
                self.qie_readBox = OptionMenu(self.qie_subMid_frame, self.qieReadVar,
                                              "Placeholder R1","Placeholder R2",
				              "Placeholder R3","Placeholder R4")
                self.qie_readBox.pack(side=LEFT)
                self.qieReadVar.set("Placeholder R1") # initializes the OptionMenu
	...
	def fanoutClickWrite(self):
		...
		print "This should read something fanoutWrite"
		self.fanoutClickRead()

	def fanoutClickRead(self):
		self.fanoutHexText.set("This should read something")
	...
	def ngccmClickWrite(self):
		...
		print "this should read something."
		self.ngccmClickRead()

	def ngccmClickRead(self):
		self.ngccmHexText.set("this should read some hex")
